  ...
  <div id="injury"
    ...
    <div class="top-menu">
        ...
        <div class="portait-text">
            <div class="text-name"><span class="text-game">每日篮彩推荐</span>请关注微信公众号：<strong>[篮彩老黑]</strong><img src="https://lancailaohei.oss-cn-hangzhou.aliyuncs.com/common/arrow.png" /><span class="scan">可扫一扫右侧二维码</span></div>
            <div class="text-notice">NBA伤病名单实时更新、NBA篮彩推荐、NBA篮彩投注率更新</div>
        </div>
