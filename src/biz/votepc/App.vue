<template>
  <div id="injury"
    ...
    <ul class="nav">
        ...
        <li class="lancai"><a href="/lancaipc.html">篮彩经验学习</a></li>
    ...
    <table class="list" border="0" cellspacing="1" cellpadding="0">
        ...
        <template v-for="(item,index) in currentData">
            <tr class="play-time-tr" :key="index">  
                <td rowspan="3" class="play-time">{{item.time}}<br/><span class="play-live" v-if="item.live"><全美直播></span></td>
            </tr> 
...
<script>
import { myData } from '../common/data/mydata_vote_4.js';
