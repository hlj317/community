const wnbaData = {
    ...
    dream:[
        {
            'name':'尼娅.科菲',
            'status':'出战存疑',
            'detail':'膝盖受伤，周一对阵风暴的比赛出战存疑；2022场均数据：6.5分/5.5篮板/0.9助攻/0.6抢断',
            'important':true
        }
    ],
    //芝加哥天空
    ...
    sparks:[
        {
            ...
            'name':'赛克斯',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战；2022场均数据：10.3分/3.5篮板/3.9助攻/2.1抢断',
            'important':true
        },{
            'name':'托利弗',
            'status':'缺阵',
            'detail':'身体不适，周二对阵火花的比赛出战存疑；2022场均数据：5.7分/0.9篮板/4.1助攻/0.6抢断',
            'important':false
        },{
            'name':'钱内迪.卡特',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周二对阵火花的比赛；2022场均数据：7.8分/1.6篮板/2.0助攻/0.5抢断',
            'important':false
        }
    ],
    //明尼苏达山猫
    ...
    liberty:[
        {        
            ...
            'name':'丽贝卡.阿伦',
            'status':'出战存疑',
            'detail':'腿部受伤，周一对阵火花的比赛出战存疑；2022场均数据：8.7分/3.6篮板/1.5助攻/0.抢断',
            'important':false
        },{        
            'name':'萨巴利',
            'status':'长期缺阵',
    ...
    mystics:[
        {
            'name':'伊丽莎白.威廉姆斯',
            'status':'出战存疑',
            'detail':'腿部受伤，每日观察；2022场均数据：6.5分/4.4篮板/0.6助攻/0.5抢断',
            'important':false
        },{
            'name':'多恩',
            'status':'轮休',
            'detail':'伤病管理，无法出战周一对阵阳光的比赛；2022场均数据：15.3分/5.9篮板/2.1助攻/0.6抢断',
            'important':true
        }
    ]  
}
