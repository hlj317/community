    ...
    aces:[
        {
            ...
            'name':'坎迪斯.帕克',
            'status':'缺阵',
            'detail':'脚踝受伤，无法出战周三对阵水星的比赛；2022场均数据：12.1分/6.7篮板/3.2助攻/1.2抢断',
            'important':true
        }
    ],
    //洛杉矶火花
    sparks:[
        {
            ...
            'name':'卡莉.萨缪尔森',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周一对阵水星的比赛；2023场均数据：7.8分/2.2篮板/1.7助攻/0.6抢断',
            'important':false
        },{
            'name':'奇妮.奥古米克',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周四对阵王牌的比赛；2023场均数据：8.4分/4.3篮板/1.3助攻/1.3抢断',
            'important':false
        }
    ],
    //明尼苏达山猫
    ...
    mystics:[
        {
            ...
            'name':'阿特金斯',
            'status':'缺阵',
            'detail':'脚踝扭伤，预计缺阵两周时间；2023场均数据：11.0分/3.4篮板/6.1助攻/0.9抢断',
            'important':true
        }
    ]  
}
