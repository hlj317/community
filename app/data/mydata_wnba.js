    ...
    dream:[
        {
            ...
            'name':'艾丽卡.维勒',
            'status':'缺阵',
            'detail':'左脚扭伤，无法出战周六对阵自由人的比赛；2022场均数据：9.7分/3.3篮板/3.8助攻/1.3抢断',
            'important':true
        },{
            'name':'基亚.沃恩',
            'status':'缺阵',
            'detail':'身体不适，无法出战周六对阵自由人的比赛；2022场均数据：2.8分/2.4篮板/1.0助攻/0.3抢断',
            'important':false
        },{
            'name':'尼娅.科菲',
            'status':'缺阵',
            'detail':'膝盖受伤，无法出战周六对阵自由人的比赛；2022场均数据：6.5分/5.5篮板/0.9助攻/0.6抢断',
            'important':true
        },{
            'name':'克里斯蒂.华莱士',
            'status':'缺阵',
            'detail':'身体不适，无法出战周六对阵自由人的比赛；2022场均数据：8.3分/2.9篮板/2.3助攻/1.0抢断',
            'important':false
        }
    ],
    //芝加哥天空
