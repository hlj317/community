const wnbaData = {
    ...
    dream:[
        {
            ...
            'name':'艾丽卡.维勒',
            'status':'缺阵',
            'detail':'左脚扭伤，无法出战；2022场均数据：9.7分/3.3篮板/3.8助攻/1.3抢断',
            'important':true
        },{
            'name':'基亚.沃恩',
            'status':'缺阵',
            ...
            'name':'克里斯蒂.华莱士',
            'status':'缺阵',
            'detail':'身体不适，无法出战；2022场均数据：8.3分/2.9篮板/2.3助攻/1.0抢断',
            'important':false
        }
    ],
    //芝加哥天空
    sky:[
        {        
            ...
            'name':'坎迪斯.帕克',
            'status':'出战存疑',
            'detail':'膝盖受伤，周三对阵王牌的比赛出战存疑；2022场均数据：12.3分/7.9篮板/4.5助攻/0.8抢断',
            'important':true
        }
    ],
    //康涅狄克阳光
    ...
    lynx:[
        {
            ...
            'name':'阿卓娃',
            'status':'出战存疑',
            'detail':'腿筋受伤，周三对阵水星的比赛出战存疑；2022场均数据：2.5分/1.0篮板/0.5助攻/0.0抢断',
            'important':false
        },{
            'name':'科利尔',
            'status':'长期缺阵',
    ...
    mystics:[
        {
            'name':'多恩',
            'status':'轮休',
            'detail':'伤病管理，无法出战周三对阵火花的比赛；2022场均数据：14.9分/5.8篮板/2.2助攻/0.6抢断',
            'important':true
        }
    ]  
}
