    ...
    fever:[
        {
            ...
            'name':'维维安',
            'status':'出战存疑',
            'detail':'肩膀受伤，周三对阵风暴的比赛出战存疑；2022场均数据：11.3分/3.4篮板/2.7助攻/1.1抢断',
            'important':true
        },{
            'name':'埃格博',
            'status':'出战存疑',
            'detail':'腿部受伤，无法出战周三对阵风暴的比赛；2022场均数据：7.6分/6.9篮板/1.0助攻/1.0抢断',
            'important':true
        }
    ],
    //拉斯维加斯王牌
    ...
    sparks:[
        {
            ...
            'name':'托利弗',
            'status':'缺阵',
            'detail':'身体不适，无法出战周二对阵火花的比赛；2022场均数据：5.7分/0.9篮板/4.1助攻/0.6抢断',
            'important':false
        },{
            'name':'钱内迪.卡特',
            'status':'缺阵',
