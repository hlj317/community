const wnbaData = {
    ...
    sun:[
        {        
            ...
            'name':'卡琳顿',
            'status':'出战存疑',
            'detail':'身体不适，周一对阵神秘人的比赛出战存疑；2023场均数据：8.8分/2.9篮板/1.3助攻/0.5抢断',
            'important':false
        }
    ],
    //达拉斯飞翼
    wings:[
        {
            ...
            'name':'卡拉尼.布朗',
            'status':'出战存疑',
            'detail':'头部受伤，周一对阵狂热的比赛出战存疑；2023场均数据：7.9分/6.9篮板/1.2助攻/0.4抢断',
            'important':false
        }
    ],
    //印第安纳狂热
    ...
    sparks:[
        {
            ...
            'name':'卡莉.萨缪尔森',
            'status':'出战存疑',
            'detail':'腿部受伤，周一对阵水星的比赛出战存疑；2023场均数据：7.8分/2.2篮板/1.7助攻/0.6抢断',
            'important':false
        },{
            'name':'奇妮.奥古米克',
            'status':'出战存疑',
            'detail':'腿部受伤，周一对阵水星的比赛出战存疑；2023场均数据：8.4分/4.3篮板/1.3助攻/1.3抢断',
            'important':false
        },{
            'name':'哈姆比',
            'status':'出战存疑',
            'detail':'身体不适，周一对阵水星的比赛出战存疑；2023场均数据：10.1分/6.6篮板/2.1助攻/0.8抢断',
            'important':true
        }
    ],
    //明尼苏达山猫
    ...
    mercury:[
        {
            ...
            'name':'陶乐西',
            'status':'出战',
            'detail':'可以出战周一对阵火花的比赛；2023场均数据：14.5分/3.5篮板/5.3助攻/0.6抢断',
            'important':true
        }
    ],
    //西雅图风暴
    ...
    mystics:[
        {
            ...
            'name':'多恩',
            'status':'出战',
            'detail':'可以出战周一对阵阳光的比赛；2023场均数据：19.5分/6.3篮板/2.6助攻/0.7抢断',
            'important':true
        },{
            'name':'娜塔莎.克劳德',
            'status':'出战存疑',
            'detail':'脚踝受伤，周一对阵阳光的比赛出战存疑；2023场均数据：11.0分/3.4篮板/6.1助攻/0.9抢断',
            'important':true
        }
    ]  
}
