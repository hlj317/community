const wnbaData = {
    ...
    lynx:[
        {
            ...
            'name':'鲍尔斯',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周三对阵火花的比赛；2023场均数据：5.4分/2.1篮板/0.4助攻/0.3抢断',
            'important':false
        },{
            'name':'谢波德',
            'status':'缺阵',
            'detail':'身体不适，无法出战周三对阵火花的比赛；2023场均数据：9.3分/9.1篮板/4.3助攻/0.6抢断',
            'important':true
        },{
            'name':'阿卓娃',
            'status':'缺阵',
    ...
    liberty:[
        {        
            'name':'约内斯库',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周一对阵水星的比赛；2023场均数据：16.5分/6.3篮板/4.3助攻/1.0抢断',
            'important':true
        },{        
            'name':'乔斯林.威洛比',
            'status':'出战存疑',
