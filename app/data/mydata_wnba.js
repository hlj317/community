const wnbaData = {
    ...
    sky:[
        {        
            'name':'阿尔曼德',
            'status':'出战存疑',
            'detail':'禁赛结束，周四对阵神秘人的比赛出战存疑；2021场均数据：8.5分/4.5篮板/5.8助攻/1.1抢断',
            'important':true
        },{        
            'name':'李月汝',
            'status':'出战',
            'detail':'可以出战周四对阵神秘人的比赛；2022场均数据：2.0分/2.5篮板/0.0助攻/0.5抢断',
            'important':false
        }
    ],
    //康涅狄克阳光
    ...
    mystics:[
        {
            'name':'多恩',
            'status':'出战',
            'detail':'可以出战周一对阵天空的比赛；2022场均数据：17.5分/6.8篮板/2.1助攻/0.6抢断',
            'important':true
        }
    ]  
}
