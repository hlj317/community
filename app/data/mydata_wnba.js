    ...
    wings:[
        {
            ...
            'name':'卡拉尼.布朗',
            'status':'出战存疑',
            'detail':'脑震荡休战，周四对阵自由人的比赛出战存疑；2023场均数据：7.9分/6.9篮板/1.2助攻/0.4抢断',
            'important':false
        }
    ],
    //印第安纳狂热
    fever:[
        {
            ...
            'name':'莱克西.赫尔',
            'status':'出战存疑',
            'detail':'鼻子受伤，周三对阵神秘人的比赛出战存疑；2023场均数据：5.7分/3.1篮板/0.9助攻/1.1抢断',
            'important':false
        }
    ],
    //拉斯维加斯王牌
    ...
    sparks:[
        {
            'name':'克莱伦敦',
            'status':'出战',
            'detail':'可以出战周五对阵山猫的比赛；2023场均数据：7.8分/3.0篮板/3.7助攻/1.7抢断',
            'important':true
        },{
            'name':'莱斯利.布朗',
            'status':'出战存疑',
    ...
    lynx:[
        {
            'name':'蒂芙尼.米切尔',
            'status':'出战',
            'detail':'可以出战周三对阵梦想的比赛；2023场均数据：10.5分/3.3篮板/2.5助攻/0.7抢断',
            'important':true
        },{
            'name':'鲍尔斯',
            'status':'缺阵',
    ...
    mercury:[
        {
            ...
            'name':'陶乐西',
            'status':'缺阵',
            'detail':'腿筋拉伤，无法出战周五对阵天空的比赛；2023场均数据：14.8分/3.3篮板/5.3助攻/0.6抢断',
            'important':true
        }
    ],
    //西雅图风暴
