const wnbaData = {
    ...
    dream:[
        {
            'name':'尼娅.科菲',
            'status':'缺阵',
            'detail':'膝盖受伤，无法出战周一对阵水星的比赛；2022场均数据：6.5分/5.5篮板/0.9助攻/0.6抢断',
            'important':true
        },{
            'name':'莱恩.霍华德',
            'status':'缺阵',
            'detail':'肩膀受伤，无法出战周一对阵水星的比赛；2022场均数据：14.7分/4.4篮板/2.7助攻/1.5抢断',
            'important':true
        },{
            'name':'比林斯',
            'status':'缺阵',
            'detail':'脚踝受伤，无法出战周一对阵水星的比赛；2022场均数据：6.2分/6.2篮板/1.0助攻/0.9抢断',
            'important':true
        }
    ],
    //芝加哥天空
    ...
    sun:[
        {        
            ...
            'name':'琼奎尔.琼斯',
            'status':'缺阵',
            'detail':'身体不适，无法出战周一对阵王牌的比赛；2021场均数据：15.1分/9.0篮板/1.8助攻/1.1抢断',
            'important':true
        }
    ],
    //达拉斯飞翼
