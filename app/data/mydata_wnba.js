const wnbaData = {
    ...
    fever:[
        {
            ...
            'name':'维维安',
            'status':'出战',
            'detail':'可以出战周日对阵王牌的比赛；2022场均数据：5.4分/2.4篮板/1.5助攻/0.5抢断',
            'important':false
        }
    ],
    //拉斯维加斯王牌
    ...
    sparks:[
        {
            ...
            'name':'莱斯利.布朗',
            'status':'缺阵',
            'detail':'身体不适，无法出战周一对阵飞翼的比赛；2023场均数据：13.3分/2.0篮板/2.9助攻/1.2抢断',
            'important':true
        },{
            'name':'尼娅.克莱登',
            'status':'缺阵',
            'detail':'膝盖受伤，无法出战周一对阵飞翼的比赛；2023场均数据：1.6分/0.4篮板/1.8助攻/0.1抢断',
            'important':false
        },{
            'name':'塞缪尔森',
            'status':'长期缺阵',
    ...
    liberty:[
        {        
            'name':'道尔森',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周一对阵神秘人的比赛；2023场均数据：3.4分/2.0篮板/1.5助攻/0.1抢断',
            'important':false
        },{        
            'name':'乔斯林.威洛比',
            'status':'出战存疑',
    ...
    storm:[
        {
            ...
            'name':'杰登.休士敦',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周日对阵水星的比赛；2023场均数据：7.5分/5.8篮板/1.1助攻/1.1抢断',
            'important':false
        }
    ],
    //华盛顿神秘人
