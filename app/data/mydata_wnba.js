const wnbaData = {
    ...
    wings:[
        {
            'name':'麦考文',
            'status':'出战存疑',
            'detail':'膝盖受伤，周六对阵神秘人的比赛出战存疑；2023场均数据：4.0分/9.0篮板/0.2助攻/0.1抢断',
            'important':true
        },{
            'name':'德希尔兹',
            'status':'长期缺阵',
    ...
    liberty:[
        {        
            'name':'约翰尼斯',
            'status':'出战存疑',
            'detail':'腿部受伤，周六对阵天空的比赛出战存疑；2022场均数据：10.0分/2.1篮板/3.7助攻/0.6抢断',
            'important':true
        }
    ],
    //菲尼克斯水星
    ...
    mystics:[
        {
            'name':'海恩斯-艾伦',
            'status':'缺阵',
            'detail':'膝盖受伤，预计会缺阵几场比赛；2022场均数据：2.5分/6.5篮板/3.5助攻/1.0抢断',
            'important':true
        }
    ]  
}
