const wnbaData = {
    ...
    sky:[
        {        
            ...
            'name':'达娜.埃文斯',
            'status':'出战存疑',
            'detail':'身体不适，周三对阵狂热的比赛出战存疑；2023场均数据：9.3分/1.2篮板/3.2助攻/0.5抢断',
            'important':true
        }
    ],
    //康涅狄克阳光
    ...
    fever:[
        {
            'name':'维维安',
            'status':'出战',
            'detail':'可以出战周三对阵天空的比赛；2023场均数据：2.8分/2.0篮板/0.8助攻/1.3抢断',
            'important':false
        },{
            'name':'博纳戴特.哈特',
            'status':'长期缺阵',
    ...
    mystics:[
        {
            'name':'托利弗',
            'status':'出战',
            'detail':'可以出战周四对阵飞翼的比赛；2023场均数据：4.0分/0.6篮板/0.6助攻/0.4抢断',
            'important':false
        }
    ]  
}
