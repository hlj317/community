    ...
    sparks:[
        {
            ...
            'name':'奇妮.欧古米克',
            'status':'缺阵',
            'detail':'个人原因，无法出战周五对阵天空的比赛；2022场均数据：6.6分/4.8篮板/0.8助攻/0.8抢断',
            'important':false
        }
    ],
    //明尼苏达山猫
    lynx:[
        {
            'name':'福尔斯',
            'status':'出战',
            'detail':'可以出战周五对阵水星的比赛；2022场均数据：16.5分/10.3篮板/1.0助攻/1.5抢断',
            'important':true
        },{
            'name':'科利尔',
            'status':'长期缺阵',
    ...
    mystics:[
        {
            'name':'多恩',
            'status':'出战',
            'detail':'可以出战周五对阵风暴的比赛；2022场均数据：14.9分/5.8篮板/2.2助攻/0.6抢断',
            'important':true
        },{
            'name':'伊丽莎白.威廉姆斯',
            'status':'缺阵',
            'detail':'个人私事，无法出战周五对阵风暴的比赛；2022场均数据：6.5分/4.4篮板/0.6助攻/0.5抢断',
            'important':false
        }
    ]  
}
