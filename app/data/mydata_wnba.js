const wnbaData = {
    ...
    aces:[
        {
            ...
            'name':'普拉姆',
            'status':'出战存疑',
            'detail':'身体不适，周六对阵飞翼的比赛出战存疑；2022场均数据：17.6分/2.2篮板/4.0助攻/0.9抢断',
            'important':true
        }
    ],
    //洛杉矶火花
    ...
    liberty:[
        {        
            ...
            'name':'韩旭',
            'status':'出战存疑',
            'detail':'回归到球队，每日观察；2023场均数据：0.8分/0.4篮板/0.1助攻/0.2抢断',
            'important':false
        }
    ],
    //菲尼克斯水星
    ...
    storm:[
        {
            ...
            'name':'盖比.威廉姆斯',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周五对阵阳光的比赛；2023场均数据：7.5分/5.0篮板/2.5助攻/1.0抢断',
            'important':false
        }
    ],
    //华盛顿神秘人
    mystics:[
        {
            ...
            'name':'多恩',
            'status':'出战存疑',
            'detail':'脚踝受伤，周六对阵狂热的比赛出战存疑；2023场均数据：19.5分/6.3篮板/2.6助攻/0.7抢断',
            'important':true
        },{
            'name':'娜塔莎.克劳德',
            'status':'出战存疑',
            'detail':'脚踝受伤，周六对阵狂热的比赛出战存疑；2023场均数据：11.0分/3.4篮板/6.1助攻/0.9抢断',
            'important':true
        }
    ]  
}
