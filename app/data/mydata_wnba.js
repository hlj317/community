const wnbaData = {
    ...
    sparks:[
        {
            ...
            'name':'乔丁.肯娜达',
            'status':'出战存疑',
            'detail':'肩部受伤，周四对阵梦想的比赛出战存疑；2023场均数据：13.0分/3.2篮板/5.7助攻/1.9抢断',
            'important':true
        },{
            'name':'奇妮.奥古米克',
            'status':'缺阵',
    ...
    liberty:[
        {        
            ...
            'name':'韩旭',
            'status':'缺阵',
            'detail':'回归到球队，无法出战周四对阵水星的比赛；2023场均数据：0.8分/0.4篮板/0.1助攻/0.2抢断',
            'important':false
        }
    ],
    //菲尼克斯水星
    mercury:[
        {
            ...
            'name':'坎宁安',
            'status':'出战存疑',
            'detail':'头部受伤，周四对阵自由人的比赛出战存疑；2023场均数据：13.5分/2.4篮板/2.1助攻/0.7抢断',
            'important':true
        },{        
            'name':'谢伊.佩迪',
            'status':'出战存疑',
            'detail':'跟腱受伤，周四对阵自由人的比赛出战存疑；2023场均数据：5.3分/1.0篮板/2.3助攻/0.8抢断',
            'important':false
        }
    ],
    //西雅图风暴
    ...
    mystics:[
        {
            ...
            'name':'李梦',
            'status':'出战存疑',
            'detail':'回归到球队之中，周六对阵狂热的比赛出战存疑；2023场均数据：4.6分/1.3篮板/0.6助攻/0.2抢断',
            'important':false
        },{
            'name':'奥斯汀',
            'status':'缺阵',
