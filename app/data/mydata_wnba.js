    ...
    fever:[
        {
            'name':'纳莉莎史密斯',
            'status':'出战存疑',
            'detail':'腿部受伤，周六对阵阳光的比赛出战存疑；2022场均数据：13.0分/10.0篮板/1.6助攻/0.6抢断',
            'important':true
        },{
            'name':'哈特利',
            'status':'缺阵',
    ...
    mercury:[
        {
            ...
            'name':'迪金斯史密斯',
            'status':'出战存疑',
            'detail':'身体不适，周日对阵王牌的比赛出战存疑；2022场均数据：17.0分/4.3篮板/4.5助攻/1.0抢断',
            'important':true
        }
    ],
    //西雅图风暴
    ...
    mystics:[
        {
            'name':'伊丽莎白.威廉姆斯',
            'status':'出战',
            'detail':'可以出战周六对阵梦想的比赛；2021场均数据：5.8分/4.9篮板/1.2助攻/1.1抢断',
            'important':false
        },{
            'name':'艾因斯.阿伦',
            'status':'出战存疑',
            'detail':'腿部受伤，周六对阵梦想的比赛出战存疑；2022场均数据：8.6分/6.2篮板/3.6助攻/0.8抢断',
            'important':true
        },{
            'name':'多恩',
            'status':'缺阵',
            'detail':'背部不适，无法出战周六对阵梦想的比赛；2022场均数据：18.5分/6.5篮板/2.8助攻/0.3抢断',
            'important':true
        }
    ]  
}
