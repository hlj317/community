const wnbaData = {
    ...
    sun:[
        {        
            ...
            'name':'卡琳顿',
            'status':'缺阵',
            'detail':'身体不适，无法出战周六对阵风暴的比赛；2023场均数据：8.8分/2.9篮板/1.3助攻/0.5抢断',
            'important':false
        }
    ],
    //达拉斯飞翼
    wings:[
        {
            ...
            'name':'卡拉尼.布朗',
            'status':'出战存疑',
            'detail':'头部受伤，周六对阵王牌的比赛出战存疑；2023场均数据：7.9分/6.9篮板/1.2助攻/0.4抢断',
            'important':false
        },{
            'name':'萨图.萨巴利',
            'status':'出战',
            'detail':'可以出战周六对阵王牌的比赛；2023场均数据：18.5分/9.8篮板/3.4助攻/1.4抢断',
            'important':true
        }
    ],
    //印第安纳狂热
    ...
    aces:[
        {
            ...
            'name':'普拉姆',
            'status':'出战',
            'detail':'可以出战周六对阵飞翼的比赛；2022场均数据：17.6分/2.2篮板/4.0助攻/0.9抢断',
            'important':true
        }
    ],
    //洛杉矶火花
    sparks:[
        {
            ...
            'name':'乔丁.肯娜达',
            'status':'出战',
            'detail':'可以出战周四对阵梦想的比赛；2023场均数据：13.0分/3.2篮板/5.7助攻/1.9抢断',
            'important':true
        },{
            'name':'奇妮.奥古米克',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周四对阵梦想的比赛；2023场均数据：8.4分/4.3篮板/1.3助攻/1.3抢断',
            'important':false
        }
    ],
    //明尼苏达山猫
    ...
    mercury:[
        {
            ...
            'name':'陶乐西',
            'status':'缺阵',
            'detail':'身体不适，无法出战周六对阵山猫的比赛；2023场均数据：14.5分/3.5篮板/5.3助攻/0.6抢断',
            'important':true
        }
    ],
    //西雅图风暴
    storm:[
        {
            ...
            'name':'盖比.威廉姆斯',
            'status':'缺阵',
            'detail':'身体不适，无法出战周日对阵自由人的比赛；2023场均数据：7.5分/5.0篮板/2.5助攻/1.0抢断',
            'important':false
        }
    ],
    //华盛顿神秘人
    mystics:[
        {
            ...
            'name':'李梦',
            'status':'出战',
            'detail':'可以出战周六对阵狂热的比赛；2023场均数据：4.6分/1.3篮板/0.6助攻/0.2抢断',
            'important':false
        },{
            'name':'奥斯汀',
            'status':'缺阵',
            ...
            'name':'多恩',
            'status':'缺阵',
            'detail':'脚踝受伤，无法出战周六对阵狂热的比赛；2023场均数据：19.5分/6.3篮板/2.6助攻/0.7抢断',
            'important':true
        },{
            'name':'娜塔莎.克劳德',
            'status':'出战存疑',
            'detail':'脚踝受伤，无法出战周六对阵狂热的比赛；2023场均数据：11.0分/3.4篮板/6.1助攻/0.9抢断',
            'important':true
        }
    ]  
}
