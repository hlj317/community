const wnbaData = {
    ...
    dream:[
        {
            ...
            'name':'艾丽卡.维勒',
            'status':'出战',
            'detail':'可以出战周三对阵神秘人的比赛；2022场均数据：9.7分/3.3篮板/3.8助攻/1.3抢断',
            'important':true
        },{
            'name':'基亚.沃恩',
            'status':'出战',
            'detail':'可以出战周三对阵神秘人的比赛；2022场均数据：2.8分/2.4篮板/1.0助攻/0.3抢断',
            'important':false
        },{
            'name':'尼娅.科菲',
            'status':'缺阵',
            'detail':'膝盖受伤，无法出战周三对阵神秘人的比赛；2022场均数据：6.5分/5.5篮板/0.9助攻/0.6抢断',
            'important':true
        },{
            'name':'克里斯蒂.华莱士',
            'status':'出战',
            'detail':'可以出战周三对阵神秘人的比赛；2022场均数据：8.3分/2.9篮板/2.3助攻/1.0抢断',
            'important':false
        }
    ],
    //芝加哥天空
    sky:[
        {        
            ...
            'name':'库铂',
            'status':'出战',
            'detail':'可以出战周四对阵阳光的比赛；2022场均数据：14.0分/5.5篮板/2.0助攻/0.5抢断',
            'important':true
        }
    ],
    //康涅狄克阳光
    ...
    fever:[
        {
            ...
            'name':'丹尼尔.罗宾逊',
            'status':'出战存疑',
            'detail':'个人原因，周四对阵水星的比赛出战存疑；2022场均数据：7.6分/3.3篮板/3.9助攻/0.8抢断',
            'important':false
        }
    ],
    //拉斯维加斯王牌
    aces:[
        {
            'name':'格雷',
            'status':'出战存疑',
            'detail':'腿部受伤，周四对阵风暴的比赛出战存疑；2022场均数据：12.5分/2.9篮板/6.0助攻/1.7抢断',
            'important':true
        }
    ],
    //洛杉矶火花
    ...
    storm:[
        {
            ...
            'name':'蒂娜.查尔斯',
            'status':'加盟风暴',
            'detail':'大概率会出战周四对阵王牌的比赛；2022场均数据：16.3分/6.6篮板/2.1助攻/0.8抢断',
            'important':true
        }
    ],
    //华盛顿神秘人
