    ...
    mercury:[
        {
            ...
            'name':'古斯塔夫森',
            'status':'出战存疑',
            'detail':'脑震荡不适，周日对阵山猫的比赛出战存疑；2023场均数据：4.7分/3.1篮板/0.3助攻/0.2抢断',
            'important':false
        },{        
            'name':'坎宁安',
            'status':'出战存疑',
            'detail':'头部受伤，周日对阵山猫的比赛出战存疑；2023场均数据：13.5分/2.4篮板/2.1助攻/0.7抢断',
            'important':true
        },{        
            'name':'杰弗森',
            'status':'出战存疑',
            'detail':'脚踝受伤，周日对阵山猫的比赛出战存疑；2023场均数据：8.9分/1.4篮板/2.0助攻/0.8抢断',
            'important':false
        },{        
            'name':'谢伊.佩迪',
            'status':'缺阵',
    ...
    storm:[
        {
            ...
            'name':'杰登.休士敦',
            'status':'出战存疑',
            'detail':'腿部受伤，周五对阵山猫的比赛出战存疑；2023场均数据：7.5分/5.8篮板/1.1助攻/1.1抢断',
            'important':false
        }
    ],
    //华盛顿神秘人
