const wnbaData = {
    ...
    sparks:[
        {
            ...
            'name':'莱斯利.布朗',
            'status':'缺阵',
            'detail':'身体不适，无法出战周三对阵山猫的比赛；2023场均数据：13.3分/2.0篮板/2.9助攻/1.2抢断',
            'important':true
        },{
            'name':'尼娅.克莱登',
            'status':'缺阵',
            'detail':'膝盖受伤，无法出战周三对阵山猫的比赛；2023场均数据：1.6分/0.4篮板/1.8助攻/0.1抢断',
            'important':false
        },{
            'name':'塞缪尔森',
            'status':'长期缺阵',
    ...
    liberty:[
        {        
            'name':'约内斯库',
            'status':'缺阵',
            'detail':'腿部受伤，大概率可以出战周六对阵梦想的比赛；2023场均数据：16.5分/6.3篮板/4.3助攻/1.0抢断',
            'important':true
        },{        
            'name':'乔斯林.威洛比',
            'status':'出战存疑',
