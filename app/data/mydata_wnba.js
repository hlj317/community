    ...
    lynx:[
        {
            'name':'戴蒙德.米勒',
            'status':'大概率出战',
            'detail':'脚踝受伤，大概率可以出战周三对阵风暴的比赛；2023场均数据：10.4分/3.0篮板/2.2助攻/1.0抢断',
            'important':true
        },{
            'name':'蒂芙尼.米切尔',
            'status':'缺阵',
            'detail':'左手腕受伤，无法出战周三对阵风暴的比赛；2023场均数据：10.5分/3.3篮板/2.5助攻/0.7抢断',
            'important':true
        },{
            'name':'鲍尔斯',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周三对阵风暴的比赛；2023场均数据：5.4分/2.1篮板/0.4助攻/0.3抢断',
            'important':false
        },{
            'name':'谢波德',
            'status':'缺阵',
            'detail':'身体不适，无法出战周三对阵风暴的比赛；2023场均数据：9.3分/9.1篮板/4.3助攻/0.6抢断',
            'important':true
        },{
            'name':'阿卓娃',
            'status':'缺阵',
    ...
    mercury:[
        {
            ...
            'name':'古斯塔夫森',
            'status':'出战',
            'detail':'脑震荡不适，无法出战周三对阵飞翼的比赛；2023场均数据：4.7分/3.1篮板/0.3助攻/0.2抢断',
            'important':false
        },{        
            'name':'坎宁安',
            'status':'出战存疑',
            'detail':'背部受伤，周三对阵飞翼的比赛出战存疑；2023场均数据：13.5分/2.4篮板/2.1助攻/0.7抢断',
            'important':true
        },{        
            'name':'谢伊.佩迪',
            'status':'缺阵',
            'detail':'跟腱受伤，无法出战周三对阵飞翼的比赛；2023场均数据：5.3分/1.0篮板/2.3助攻/0.8抢断',
            'important':false
        }
    ],
    //西雅图风暴
    storm:[
        {
            ...
            'name':'杰登.休士敦',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周三对阵山猫的比赛；2023场均数据：7.5分/5.8篮板/1.1助攻/1.1抢断',
            'important':false
        }
    ],
    //华盛顿神秘人
