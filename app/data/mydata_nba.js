    ...
    cavaliers:[
        {
            ...
            'name':'乐福',
            'status':'出战存疑',
            'detail':'周四对阵开拓者的比赛出战存疑',
            'important':true
        },{
            'name':'勒维尔',
            'status':'缺阵',
            'detail':'脚踝受伤，无法出战周四对阵开拓者的比赛',
            'important':true
        }
    ],
    //达拉斯独行侠
    ...
    nuggets:[
        {
            ...
            'name':'伊斯梅尔.史密斯',
            'status':'出战存疑',
            'detail':'小腿受伤，周四对阵雷霆的比赛出战存疑',
            'important':false
        },{
            'name':'海兰德',
            'status':'出战存疑',
            'detail':'臀部受伤，周四对阵雷霆的比赛出战存疑',
            'important':true
        },{
            'name':'杰夫.格林',
            'status':'长期缺阵',
    ...
    pacers:[
        {
            ...
            'name':'内姆布哈德',
            'status':'出战存疑',
            'detail':'膝盖受伤，周四对阵森林狼的比赛出战存疑',
            'important':false
        },{
            'name':'以赛亚.杰克逊',
            'status':'出战存疑',
            'detail':'脚踝受伤，周四对阵森林狼的比赛出战存疑',
            'important':false
        }
    ],
    //洛杉矶快船
    ...
    wizards:[
        {
            ...
            'name':'八村塁',
            'status':'缺阵',
            'detail':'脚踝扭伤，周四对阵热火的比赛出战存疑',
            'important':false
        },{
            'name':'比尔',
            'status':'出战存疑',
            'detail':'四头肌受伤，周四对阵热火的比赛出战存疑',
            'important':true
        },{
            'name':'德隆.赖特',
            'status':'长期缺阵',
