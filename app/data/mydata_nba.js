    ...
    celtics:[
        {
            ...
            'name':'内史密斯',
            'status':'缺阵',
            'detail':'脚踝受伤，无法出战周六对对阵开拓者的比赛',
            'important':false
        },{
            'name':'斯马特',
            'status':'缺阵',
            'detail':'新冠刚转阴性，无法出战周六对对阵开拓者的比赛',
            'important':true
        },{        
            'name':'波尔',
            'status':'缺阵',
