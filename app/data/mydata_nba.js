    ...
    blazers:[
        {
            ...
            'name':'尤班克斯',
            'status':'出战存疑',
            'detail':'身体不适，周四对阵勇士的比赛出战存疑',
            'important':false
        },{
            'name':'基翁.约翰逊',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周四对阵勇士的比赛出战存疑',
            'important':false
        }
    ],
    //萨克拉门托国王
