    ...
    nuggets:[
        {
            ...
            'name':'贾马尔.默雷',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周四对阵快船的比赛出战存疑',
            'important':true
        },{
            'name':'阿隆.戈登',
            'status':'出战存疑',
            'detail':'脚后跟受伤，周四对阵快船的比赛出战存疑',
            'important':true
        }
    ],
    //底特律活塞
