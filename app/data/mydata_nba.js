    ...
    spurs:[
        {
            ...
            'name':'凯尔登.约翰逊',
            'status':'出战存疑',
            'detail':'背部受伤，周三对阵雷霆的比赛出战存疑',
            'important':true
        },{
            'name':'麦克德莫特',
            'status':'出战存疑',
            'detail':'右膝受伤，周三对阵雷霆的比赛出战存疑',
            'important':true
        }
    ],
    //多伦多猛龙
