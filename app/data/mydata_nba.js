const nbaData = {
    ...
    celtics:[
        {        
            ...
            'name':'杰伦.布朗',
            'status':'出战存疑',
            'detail':'背部受伤，周三对阵76人的比赛出战存疑',
            'important':true
        },{        
            'name':'罗伯特.威廉姆斯',
            'status':'缺阵',
            'detail':'伤病管理，无法出战周三对阵76人的比赛',
            'important':false
        }
    ],
    //布鲁克林篮网
    ...
    blazers:[
        {
            ...
            'name':'雷迪什',
            'status':'出战存疑',
            'detail':'背部受伤，周三对阵灰熊的比赛出战存疑',
            'important':false
        },{
            'name':'赛布尔',
            'status':'出战存疑',
            'detail':'膝盖受伤，周三对阵灰熊的比赛出战存疑',
            'important':false
        },{
            'name':'诺克斯',
            'status':'出战存疑',
    ...
    spurs:[
        {
            ...
            'name':'凯尔登.约翰逊',
            'status':'出战存疑',
            'detail':'腿部受伤，周三对阵太阳的比赛出战存疑',
            'important':true
        },{
            'name':'扎克.科林斯',
            'status':'出战存疑',
            'detail':'手指受伤，周三对阵太阳的比赛出战存疑',
            'important':false
        },{
            'name':'瓦塞尔',
            'status':'缺阵',
    ...
    raptors:[
        {
            ...
            'name':'小特伦特',
            'status':'出战存疑',
            'detail':'肘部受伤，周三对阵黄蜂的比赛出战存疑',
            'important':false
        },{
            'name':'阿奴诺比',
            'status':'出战存疑',
            'detail':'脚踝受伤，周三对阵黄蜂的比赛出战存疑',
            'important':true
        }
    ],
    //犹它爵士
