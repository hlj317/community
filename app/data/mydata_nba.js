    ...
    celtics:[
        {
            ...
            'name':'德里克.怀特',
            'status':'出战存疑',
            'detail':'左脚踝扭伤，周四对阵马刺的比赛出战存疑',
            'important':true
        },{
            'name':'波尔津吉斯',
            'status':'出战存疑',
            'detail':'右膝受伤，周四对阵马刺的比赛出战存疑',
            'important':true
        },{
            'name':'朱.霍乐迪',
            'status':'出战存疑',
            'detail':'右手肘受伤，周四对阵马刺的比赛出战存疑',
            'important':true
        }
    ],
    //布鲁克林篮网
    ...
    hornets:[
        {
            ...
            'name':'布兰登.米勒',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周四对阵鹈鹕的比赛出战存疑',
            'important':false
        },{
            'name':'麦克格文斯',
            'status':'出战存疑',
            'detail':'腿部受伤，周四对阵鹈鹕的比赛出战存疑',
            'important':false
        }
    ],
    //芝加哥公牛
    ...
    knicks:[
        {
            ...
            'name':'杰伦.布伦森',
            'status':'出战存疑',
            'detail':'左小腿受伤，周四对阵火箭的比赛出战存疑',
            'important':true
        },{
            'name':'约什.哈特',
            'status':'出战存疑',
            'detail':'腿部受伤，周四对阵火箭的比赛出战存疑',
            'important':false
        }
    ],
    //俄克拉荷马城雷霆
    ...
    seven6ers:[
        {
            ...
            'name':'班巴',
            'status':'缺阵',
            'detail':'右膝酸痛，无法出战周三对阵掘金的比赛',
            'important':false
        },{
            'name':'斯普林格',
            'status':'缺阵',
            'detail':'右脚踝扭伤，无法出战周三对阵掘金的比赛',
            'important':false
        },{
            'name':'斯普林格',
            'status':'缺阵',
