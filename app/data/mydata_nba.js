    ...
    thunder:[
        {
            ...
            'name':'多尔特',
            'status':'出战存疑',
            'detail':'臀部受伤，周四对阵骑士的比赛出战存疑',
            'important':true
        },{
            'name':'迪昂',
            'status':'出战存疑',
            'detail':'手腕受伤，周四对阵骑士的比赛出战存疑',
            'important':false
        }
    ],
    //奥兰多魔术
    ...
    spurs:[
        {
            'name':'瓦塞尔',
            'status':'小概率出战',
            'detail':'腹股沟受伤，小概率可以出战周四对阵尼克斯的比赛',
            'important':true
        }
    ],
    //多伦多猛龙
