    ...
    grizzlies:[
        {
            ...
            'name':'康查尔',
            'status':'出战存疑',
            'detail':'腿部受伤，周二对阵太阳的比赛出战存疑',
            'important':false
        },{
            'name':'莫兰特',
            'status':'出战存疑',
            'detail':'左臀受伤，周二对阵太阳的比赛出战存疑',
            'important':true
        },{
            'name':'狄龙.布鲁克斯',
            'status':'出战',
    ...
    timberwolves:[
        {
            ...
            'name':'普林斯',
            'status':'出战存疑',
            'detail':'脚踝受伤，周二对阵爵士的比赛出战存疑',
            'important':false
        },{
            'name':'爱德华兹',
            'status':'出战存疑',
            'detail':'左臀受伤，周二对阵爵士的比赛出战存疑',
            'important':true
        },{
            'name':'戈贝尔',
            'status':'出战存疑',
            'detail':'腹股沟受伤，周二对阵爵士的比赛出战存疑',
            'important':true
        }
    ],
    //新奥尔良鹈鹕
    ...
    wizards:[
        {
            'name':'比尔',
            'status':'出战存疑',
            'detail':'腿筋拉伤，周二对阵勇士的比赛出战存疑',
            'important':true
        },{
            'name':'蒙特.莫里斯',
            'status':'出战存疑',
            'detail':'右腿筋拉伤，周二对阵勇士的比赛出战存疑',
            'important':true
        }
    ]   
}
