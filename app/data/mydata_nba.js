    ...
    nets:[
        {
            ...
            'name':'哈登',
            'status':'大概率出战',
            'detail':'已参加球队训练，大概率可以出战周三对阵太阳的比赛',
            'important':true
        },{
            'name':'凯里.欧文',
            'status':'视主客场而定',
    ...
    warriors:[
        {
            ...
            'name':'别利察',
            'status':'出战存疑',
            'detail':'背部受伤，周三对阵马刺的比赛出战存疑',
            'important':false
        },{
            'name':'奥托.波特',
            'status':'出战存疑',
            'detail':'身体不适，周三对阵马刺的比赛出战存疑',
            'important':false
        },{
            'name':'怀斯曼',
            'status':'缺阵',
    ...
    pacers:[
        {
            'name':'布里塞特',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周二对阵快船的比赛',
            'important':false
        },{
            'name':'比塔泽',
            'status':'出战存疑',
            'detail':'右脚受伤，无法出战周二对阵快船的比赛',
            'important':false
        },{
            'name':'布罗格登',
            'status':'缺阵',
    ...
    heat:[
        {
            ...
            'name':'吉米.巴特勒',
            'status':'出战存疑',
            'detail':'脚踝受伤，周三对阵猛龙的比赛出战存疑',
            'important':true
        },{
            'name':'PJ.塔克',
            'status':'出战存疑',
            'detail':'左膝受伤，周三对阵猛龙的比赛出战存疑',
            'important':true
        },{
            'name':'洛瑞',
            'status':'缺阵',
    ...
    timberwolves:[
        {
            'name':'奥科吉',
            'status':'出战存疑',
            'detail':'腿部受伤，周三对阵掘金的比赛出战存疑',
            'important':false
        },{
            'name':'贝弗利',
            'status':'出战存疑',
            'detail':'脚踝受伤，周三对阵掘金的比赛出战存疑',
            'important':true
        },{
            'name':'拉塞尔',
            'status':'出战存疑',
            'detail':'左胫骨挫伤，周三对阵掘金的比赛出战存疑',
            'important':true
        },{
            'name':'莱特',
            'status':'出战存疑',
    ...
    seven6ers:[
        {
            'name':'科尔克马兹',
            'status':'缺阵',
            'detail':'左膝受伤，无法出战周二对阵灰熊的比赛',
            'important':false
        },{
            'name':'恩比德',
            'status':'轮休',
            'detail':'身体不适，无法出战周二对阵灰熊的比赛',
            'important':true
        },{
            'name':'米尔顿',
            'status':'缺阵',
    ...
    suns:[
        {
            ...
            'name':'杰.克劳德',
            'status':'缺阵',
            'detail':'手腕受伤，无法出战周三对阵篮网的比赛',
            'important':true
        },{
            'name':'艾顿',
            'status':'缺阵',
            'detail':'右脚踝受伤，无法出战周三对阵篮网的比赛',
            'important':true
        },{
            'name':'纳达尔',
            'status':'缺阵',
    ...
    spurs:[
        {
            'name':'珀尔特尔',
            'status':'出战存疑',
            'detail':'背部受伤，周三对阵勇士的比赛出战存疑',
            'important':true
        },{
            'name':'默里',
            'status':'出战存疑',
            'detail':'脚踝受伤，周三对阵勇士的比赛出战存疑',
            'important':true
        },{
            'name':'德里克.怀特',
            'status':'出战存疑',
