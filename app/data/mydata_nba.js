    ...
    nuggets:[
        {
            ...
            'name':'小波特',
            'status':'缺阵',
            'detail':'脚后跟受伤，无法出战周六对阵老鹰的比赛',
            'important':true
        },{
            'name':'杰夫.格林',
            'status':'缺阵',
            'detail':'膝盖受伤，无法出战周六对阵老鹰的比赛',
            'important':false
        }
    ],
    //底特律活塞
