    ...
    pacers:[
        {
            ...
            'name':'特纳',
            'status':'出战存疑',
            'detail':'腿筋拉伤，周六对阵奇才的比赛出战存疑',
            'important':true
        },{
            'name':'詹姆斯.约翰逊',
            'status':'出战存疑',
            'detail':'手肘受伤，周六对阵奇才的比赛出战存疑',
            'important':false
        }
    ],
    //洛杉矶快船
