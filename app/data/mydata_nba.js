    ...
    knicks:[
        {
            ...
            'name':'格雷姆斯',
            'status':'缺阵',
            'detail':'左手腕受伤，无法出战周日对阵黄蜂的比赛',
            'important':true
        },{
            'name':'富尼耶',
            'status':'缺阵',
            'detail':'脚踝受伤，无法出战周日对阵黄蜂的比赛',
            'important':false
        }
    ],
    //俄克拉荷马城雷霆
