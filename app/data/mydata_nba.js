    ...
    celtics:[
        {
            'name':'豪瑟',
            'status':'出战存疑',
            'detail':'右肩受伤，周二对阵步行者的比赛出战存疑',
            'important':false
        },{
            'name':'塔图姆',
            'status':'出战存疑',
            'detail':'左脚踝扭伤，周二对阵步行者的比赛出战存疑',
            'important':true
        },{
            'name':'波尔津吉斯',
            'status':'出战存疑',
            'detail':'眼部受伤，周二对阵步行者的比赛出战存疑',
            'important':true
        }
    ],
    //布鲁克林篮网
    ...
    bulls:[
        {
            ...
            'name':'帕特里克.威廉姆斯',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周二对阵黄蜂的比赛出战存疑',
            'important':false
        },{
            'name':'卡鲁索',
            'status':'出战存疑',
            'detail':'颈部受伤，周二对阵黄蜂的比赛出战存疑',
            'important':true
        }
    ],
    //克利夫兰骑士
    ...
    pacers:[
        {
            'name':'布鲁斯.布朗',
            'status':'出战存疑',
            'detail':'膝盖受伤，周二对阵凯尔特人的比赛出战存疑',
            'important':true
        },{
            'name':'内姆布哈德',
            'status':'出战存疑',
            'detail':'背部受伤，周二对阵凯尔特人的比赛出战存疑',
            'important':false
        },{
            'name':'以赛亚.杰克逊',
            'status':'出战存疑',
            'detail':'手指受伤，周二对阵凯尔特人的比赛出战存疑',
            'important':false
        }
    ],
    //洛杉矶快船
    ...
    heat:[
        {
            ...
            'name':'克莱布.马丁',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周二对阵火箭的比赛',
            'important':false
        },{
            'name':'海史密斯',
            'status':'缺阵',
            'detail':'下巴受伤，还需要缺阵几场比赛',
            'important':false
        },{
            'name':'德鲁.史密斯',
            'status':'长期缺阵',
    ...
    bucks:[
        {
            ...
            'name':'利拉德',
            'status':'缺阵',
            'detail':'个人原因，无法出战周二对阵爵士的比赛',
            'important':true
        },{
            'name':'卡梅伦.佩恩',
            'status':'缺阵',
            'detail':'遭遇了脑震荡，无法出战周二对阵爵士的比赛',
            'important':false
        }
    ],
    //明尼苏达森林狼
    ...
    magic:[
        {
            ...
            'name':'加里.哈里斯',
            'status':'缺阵',
            'detail':'小腿受伤，无法出战周一对阵老鹰的比赛',
            'important':false
        },{
            'name':'温德勒.卡特',
            'status':'缺阵',
            'detail':'右膝受伤，无法出战周一对阵老鹰的比赛',
            'important':false
        },{
            'name':'比塔泽',
            'status':'出战',
    ...
    seven6ers:[
        {
            ...
            'name':'梅尔顿',
            'status':'缺阵',
            'detail':'背部受伤，无法出战周日对阵爵士的比赛',
            'important':false
        },{
            'name':'科文顿',
            'status':'缺阵',
            'detail':'左膝受伤，无法出战周日对阵爵士的比赛',
            'important':false
        },{
            'name':'恩比德',
            'status':'缺阵',
    ...
    suns:[
        {
            ...
            'name':'利特尔',
            'status':'缺阵',
            'detail':'左膝受伤，无法出战周一对阵灰熊的比赛',
            'important':false
        },{
            'name':'鲍尔.波尔',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周一对阵灰熊的比赛',
            'important':false
        },{
            'name':'埃里克.戈登',
            'status':'缺阵',
            'detail':'右膝受伤，无法出战周一对阵灰熊的比赛',
            'important':true
        }
    ],
    //波特兰开拓者
    ...
    wizards:[
        {
            ...
            'name':'沙梅特',
            'status':'出战存疑',
            'detail':'左腿筋拉伤，周二对阵雷霆的比赛出战存疑',
            'important':false
        },{
            'name':'迪朗.赖特',
            'status':'出战存疑',
            'detail':'左四头肌挫伤，周二对阵雷霆的比赛出战存疑',
            'important':false
        }
    ]   
}
