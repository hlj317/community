    ...
    spurs:[
        {
            ...
            'name':'肯.伯奇',
            'status':'缺阵',
            'detail':'刚被交易到球队，无法出战周六对阵活塞的比赛',
            'important':false
        },{
            'name':'格拉汉姆',
            'status':'出战',
            'detail':'刚被交易到球队，可以出战周六对阵活塞的比赛',
            'important':false
        },{
            'name':'珀尔特尔',
            'status':'缺阵',
