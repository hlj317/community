const nbaData = {
    ...
    hawks:[
        {
            ...
            'name':'奥孔古',
            'status':'缺阵',
            'detail':'脑震荡保护，无法出战周五对战公牛的比赛',
            'important':false
        },{
            'name':'科林斯',
            'status':'缺阵',
            'detail':'右脚受伤，无法出战周五对战公牛的比赛',
            'important':true
        },{
            'name':'路易斯.威廉姆斯',
            'status':'大概率出战',
            'detail':'大概率可以出战周五对战公牛的比赛',
            'important':false
        }
    ],
    //波士顿凯尔特人
    ...
    pistons:[
        {        
            'name':'弗兰克.杰克逊',
            'status':'出战存疑',
            'detail':'背部受伤，周五对阵猛龙的比赛出战存疑',
            'important':false
        },{        
            'name':'巴格利',
            'status':'出战存疑',
            'detail':'脚踝受伤，周五对阵猛龙的比赛出战存疑',
            'important':false
        }
    ],
    //金州勇士
    ...
    spurs:[
        {
            'name':'兰福德',
            'status':'出战存疑',
            'detail':'膝盖酸痛，周五对阵国王的比赛出战存疑',
            'important':false
        },{
            'name':'麦克德蒙特',
            'status':'出战存疑',
            'detail':'右膝酸痛，周五对阵国王的比赛出战存疑',
            'important':true
        }
    ],
    //多伦多猛龙
