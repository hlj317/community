    ...
    bulls:[
        {
            'name':'扎克.拉文',
            'status':'出战存疑',
            'detail':'背部受伤，周一对阵76人的比赛出战存疑',
            'important':true
        },{
            'name':'科比.怀特',
            'status':'出战存疑',
            'detail':'腹股沟受伤，周一对阵76人的比赛出战存疑',
            'important':false
        },{
            'name':'卡鲁索',
            'status':'长期缺阵',
    ...
    warriors:[
        {
            'name':'伊戈达拉',
            'status':'缺阵',
            'detail':'臀部受伤，无法出战周五对阵国王的比赛',
            'important':false
        },{
            'name':'别利察',
            'status':'缺阵',
            'detail':'背部受伤，无法出战周五对阵国王的比赛',
            'important':false
        },{
            'name':'奥托.波特',
            'status':'缺阵',
    ...
    jazz:[
        {
            'name':'克拉克森',
            'status':'出战存疑',
            'detail':'右膝受伤，周六对阵篮网的比赛出战存疑',
            'important':true
        },{
            'name':'怀特塞德',
            'status':'出战存疑',
            'detail':'背部受伤，周六对阵篮网的比赛出战存疑',
            'important':false
        },{
            'name':'鲁迪.盖伊',
            'status':'出战存疑',
