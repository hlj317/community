    ...
    celtics:[
        {
            ...
            'name':'波尔津吉斯',
            'status':'缺阵',
            'detail':'右膝酸痛，无法出战周四对阵76人的比赛',
            'important':true
        },{
            'name':'杰伦.布朗',
            'status':'缺阵',
            'detail':'身体不适，无法出战周四对阵76人的比赛',
            'important':true
        }
    ],
    //布鲁克林篮网
    ...
    seven6ers:[
        {
            'name':'巴图姆',
            'status':'缺阵',
            'detail':'个人原因，无法出战周四对阵凯尔特人的比赛',
            'important':false
        },{
            'name':'恩比德',
            'status':'出战存疑',
            'detail':'左臀受伤，周四对阵凯尔特人的比赛出战存疑',
            'important':true
        },{
            'name':'乌布雷',
            'status':'长期缺阵',
