    ...
    hawks:[
        {
            'name':'卡佩拉',
            'status':'缺阵',
            'detail':'小腿受伤，无法出战周三对阵步行者的比赛',
            'important':true
        },{
            'name':'亨特',
            'status':'缺阵',
            'detail':'脚踝受伤，无法出战周三对阵步行者的比赛',
            'important':true
        }
    ],
    //波士顿凯尔特人
