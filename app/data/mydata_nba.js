    ...
    wizards:[
        {
            'name':'八村塁',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周二对阵森林狼的比赛出战存疑',
            'important':false
        },{
            'name':'库兹马',
            'status':'出战存疑',
            'detail':'背部受伤，周二对阵森林狼的比赛出战存疑',
            'important':true
        },{
            'name':'德隆.赖特',
            'status':'长期缺阵',
