    ...
    pacers:[
        {
            'name':'比塔泽',
            'status':'大概率出战',
            'detail':'大概率可以出战周六对阵雷霆的比赛',
            'important':false
        },{
            'name':'杜阿尔特',
            'status':'出战存疑',
            'detail':'脚趾受伤，周六对阵雷霆的比赛出战存疑',
            'important':true
        },{
            'name':'以赛亚.杰克逊',
            'status':'大概率出战',
