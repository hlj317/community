    ...
    hawks:[
        {
            ...
            'name':'AJ.格里芬',
            'status':'缺阵',
            'detail':'个人原因，无法出战周日对阵骑士的比赛',
            'important':false
        },{
            'name':'卡佩拉',
            'status':'缺阵',
            'detail':'轮休一场，无法出战周日对阵骑士的比赛',
            'important':true
        },{
            'name':'博格丹',
            'status':'缺阵',
