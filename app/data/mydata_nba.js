    ...
    nuggets:[
        {
            ...
            'name':'贾马尔.穆雷',
            'status':'缺阵',
            'detail':'伤病管理，无法出战周二对阵热火的比赛',
            'important':true
        },{
            'name':'阿隆.戈登',
            'status':'缺阵',
            'detail':'身体不适，无法出战周二对阵热火的比赛',
            'important':true
        },{
            'name':'纳吉',
            'status':'缺阵',
