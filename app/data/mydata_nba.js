const nbaData = {
    ...
    celtics:[
        {        
            ...
            'name':'布罗格登',
            'status':'出战存疑',
            'detail':'腿筋拉伤，周四对阵老鹰的比赛出战存疑',
            'important':true
        },{        
            'name':'斯马特',
            'status':'大概率出战',
            'detail':'身体不适，大概率可以出战周四对阵老鹰的比赛',
            'important':true
        }
    ],
    //布鲁克林篮网
    ...
    raptors:[
        {
            ...
            'name':'小特伦特',
            'status':'出战存疑',
            'detail':'右臀受伤，周四对阵热火的比赛出战存疑',
            'important':true
        },{
            'name':'奥托.波特',
            'status':'缺阵',
            'detail':'左脚受伤，无法出战周四对阵热火的比赛',
            'important':false
        }
    ],
    //犹它爵士
