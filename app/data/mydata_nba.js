const nbaData = {
    ...
    celtics:[
        {        
            ...
            'name':'格兰特.威廉姆斯',
            'status':'出战存疑',
            'detail':'身体不适，周五对阵雄鹿的比赛出战存疑',
            'important':false
        },{        
            'name':'罗伯特.威廉姆斯',
            'status':'出战存疑',
            'detail':'右膝受伤，周五对阵雄鹿的比赛出战存疑',
            'important':false
        }
    ],
    //布鲁克林篮网
