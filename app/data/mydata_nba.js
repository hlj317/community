    ...
    nuggets:[
        {
            ...
            'name':'阿隆.戈登',
            'status':'出战存疑',
            'detail':'右脚后跟受伤，周三对阵76人的比赛出战存疑',
            'important':true
        },{
            'name':'迈克尔.波特',
            'status':'出战存疑',
            'detail':'左膝受伤，周三对阵76人的比赛出战存疑',
            'important':true
        },{
            'name':'贾马尔.默里',
            'status':'出战存疑',
    ...
    heat:[
        {
            ...
            'name':'凯文.乐福',
            'status':'缺阵',
            'detail':'膝盖受伤，无法出战周二对阵篮网的比赛',
            'important':false
        },{
            'name':'哈克斯',
            'status':'缺阵',
            'detail':'腹股沟拉伤，无法出战周二对阵篮网的比赛',
            'important':true
        },{
            'name':'德鲁.史密斯',
            'status':'长期缺阵',
    ...
    seven6ers:[
        {
            ...
            'name':'梅尔顿',
            'status':'缺阵',
            'detail':'身体不适，预计至少缺阵一周时间',
            'important':false
        },{
            'name':'班巴',
            'status':'出战存疑',
            'detail':'右膝酸痛，周三对阵掘金的比赛出战存疑',
            'important':false
        },{
            'name':'斯普林格',
            'status':'出战存疑',
            'detail':'右脚踝扭伤，周三对阵掘金的比赛出战存疑',
            'important':false
        }
    ],
    //菲尼克斯太阳
