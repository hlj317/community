    ...
    lakers:[
        {
            'name':'詹姆斯',
            'status':'缺阵',
            'detail':'腹股沟伤势，无法出战周三对阵太阳的比赛',
            'important':true
        },{
            'name':'安德森',
            'status':'缺阵',
            'detail':'背部受伤，无法出战周三对阵太阳的比赛',
            'important':false
        },{
            'name':'科尔.施威德',
            'status':'缺阵',
