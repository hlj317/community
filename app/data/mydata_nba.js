    ...
    hornets:[
        {
            ...
            'name':'马克.威廉姆斯',
            'status':'出战存疑',
            'detail':'膝盖受伤，周三对阵快船的比赛出战存疑',
            'important':false
        },{
            'name':'罗齐尔',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周三对阵快船的比赛出战存疑',
            'important':true
        },{
            'name':'布兰登.米勒',
            'status':'出战存疑',
    ...
    heat:[
        {
            'name':'巴特勒',
            'status':'缺阵',
            'detail':'小腿受伤，无法出战周二对阵76人的比赛',
            'important':true
        },{
            'name':'海史密斯',
            'status':'缺阵',
            'detail':'身体不适，无法出战周二对阵76人的比赛',
            'important':false
        },{
            'name':'约什.理查德森',
            'status':'缺阵',
            'detail':'背部受伤，无法出战周二对阵76人的比赛',
            'important':false
        },{
            'name':'德鲁.史密斯',
            'status':'长期缺阵',
    ...
    jazz:[
        {
            'name':'基昂特.乔治',
            'status':'出战存疑',
            'detail':'腿部受伤，周三对阵马刺的比赛出战存疑',
            'important':true
        },{
            'name':'塔伦.塔克',
            'status':'出战存疑',
            'detail':'左脚受伤，周三对阵马刺的比赛出战存疑',
            'important':false
        }         
    ],
    //华盛顿奇才
