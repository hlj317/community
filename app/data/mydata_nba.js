const nbaData = {
    ...
    pistons:[
        {        
            ...
            'name':'博扬',
            'status':'出战存疑',
            'detail':'伤病管理，周二对阵开拓者的比赛出战存疑',
            'important':true
        },{        
            'name':'海斯',
            'status':'出战存疑',
            'detail':'左手受伤，周二对阵开拓者的比赛出战存疑',
            'important':false
        },{        
            'name':'怀斯曼',
            'status':'出战存疑',
            'detail':'左膝受伤，周二对阵开拓者的比赛出战存疑',
            'important':false
        }
    ],
    //金州勇士
