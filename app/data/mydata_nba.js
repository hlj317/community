    ...
    jazz:[
        {
            ...
            'name':'凯斯勒',
            'status':'缺阵',
            'detail':'身体不适，无法出战周三对阵独行侠的比赛',
            'important':true
        },{
            'name':'克拉克森',
            'status':'缺阵',
            'detail':'手指受伤，无法出战周三对阵独行侠的比赛',
            'important':true
        }                      
    ],
    //华盛顿奇才
