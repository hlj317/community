    ...
    nuggets:[
        {
            ...
            'name':'阿隆.戈登',
            'status':'出战存疑',
            'detail':'脚后跟受伤，周四对阵火箭的比赛出战存疑',
            'important':true
        },{
            'name':'约基奇',
            'status':'出战存疑',
            'detail':'背部受伤，周四对阵火箭的比赛出战存疑',
            'important':true
        }
    ],
    //底特律活塞
    ...
    heat:[
        {
            ...
            'name':'巴特勒',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周三对阵雄鹿的比赛',
            'important':true
        },{
            'name':'海史密斯',
            'status':'缺阵',
            'detail':'背部受伤，无法出战周三对阵雄鹿的比赛',
            'important':false
        },{
            'name':'阿德巴约',
            'status':'出战',
    ...
    pelicans:[
        {
            ...
            'name':'CJ.麦科勒姆',
            'status':'出战存疑',
            'detail':'右肺病情有所好转，周四对阵76人的比赛出战存疑',
            'important':true
        }
    ],
    //纽约尼克斯
    ...
    jazz:[
        {
            'name':'马尔坎宁',
            'status':'缺阵',
            'detail':'左腿筋拉伤，无法出战周四对阵灰熊的比赛',
            'important':true
        },{
            'name':'克拉克森',
            'status':'出战存疑',
            'detail':'腿部受伤，周四对阵灰熊的比赛出战存疑',
            'important':true
        },{
            'name':'奥利尼克',
            'status':'出战存疑',
            'detail':'肩膀受伤，周四对阵灰熊的比赛出战存疑',
            'important':false
        }                  
    ],
    //华盛顿奇才
