const nbaData = {
    ...
    pistons:[
        {        
            ...
            'name':'杰伦.杜伦',
            'status':'缺阵',
            'detail':'右脚踝受伤，无法出战周六对阵鹈鹕的比赛',
            'important':true
        },{        
            'name':'斯图尔特',
            'status':'出战存疑',
            'detail':'肩部受伤，周六对阵鹈鹕的比赛出战存疑',
            'important':true
        }    
    ],
    //金州勇士
    ...
    suns:[
        {
            ...
            'name':'保罗',
            'status':'缺阵',
            'detail':'臀部受伤，无法出战周六对阵森林狼的比赛',
            'important':true
        },{
            'name':'沙梅特',
            'status':'缺阵',
            'detail':'腿部受伤，无法出战周六对对阵森林狼的比赛',
            'important':false
        },{
            'name':'艾顿',
            'status':'出战',
            'detail':'可以出战周六对对阵森林狼的比赛',
            'important':true
        }
    ],
    //波特兰开拓者
    ...
    wizards:[
        {
            ...
            'name':'加福德',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周六对阵尼克斯的比赛出战存疑',
            'important':false
        },{
            'name':'波尔津吉斯',
            'status':'出战存疑',
            'detail':'肋骨受伤，周六对阵尼克斯的比赛出战存疑',
            'important':true
        }
    ]   
}
