    ...
    mavericks:[
        {
            ...
            'name':'东契奇',
            'status':'缺阵',
            'detail':'四头肌拉伤，无法出战周六对阵火箭的比赛',
            'important':true
        },{
            'name':'艾克萨姆',
            'status':'缺阵',
            'detail':'左腿受伤，无法出战周六对阵火箭的比赛',
            'important':false
        },{
            'name':'塞斯.库里',
            'status':'出战存疑',
            'detail':'背部受伤，周六对阵火箭的比赛出战存疑',
            'important':false
        }
    ],
    //丹佛掘金
    ...
    magic:[
        {
            'name':'萨格斯',
            'status':'缺阵',
            'detail':'手腕扭伤，无法出战周五对阵雄鹿的比赛',
            'important':true
        },{
            'name':'富尔茨',
            'status':'缺阵',
            'detail':'膝盖肿胀，无法出战周五对阵雄鹿的比赛',
            'important':true
        },{
            'name':'英格尔斯',
            'status':'缺阵',
            'detail':'左脚踝扭伤，无法出战周五对阵雄鹿的比赛',
            'important':false
        }
    ],
    //费城76人
    ...
    jazz:[
        {
            ...
            'name':'马尔坎宁',
            'status':'缺阵',
            'detail':'伤病管理，无法出战周五对阵活塞的比赛',
            'important':true
        }  ,{
            'name':'塔伦.塔克',
            'status':'缺阵',
            'detail':'左脚受伤，无法出战周五对阵活塞的比赛',
            'important':false
        }         
    ],
    //华盛顿奇才
