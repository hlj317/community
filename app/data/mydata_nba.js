    ...
    nets:[
        {
            ...
            'name':'卡梅伦.约翰逊',
            'status':'缺阵',
            'detail':'小腿受伤，无法出战周四对阵快船的比赛',
            'important':true
        },{
            'name':'本.西蒙斯',
            'status':'缺阵',
            'detail':'臀部受伤，无法出战周四对阵快船的比赛',
            'important':true
        }
    ],
    //夏洛特黄蜂
