    ...
    mavericks:[
        {
            'name':'赛斯.库里',
            'status':'缺阵',
            'detail':'身体不适，无法出战周日对阵森林狼的季前赛',
            'important':false
        },{
            'name':'马基夫.莫里斯',
            'status':'缺阵',
            'detail':'左脚踝受伤，无法出战周日对阵森林狼的季前赛',
            'important':false
        },{
            'name':'凯里.欧文',
            'status':'缺阵',
            'detail':'腹股沟受伤，无法出战周日对阵森林狼的季前赛',
            'important':true
        }
    ],
    //丹佛掘金
    ...
    clippers:[
        {
            ...
            'name':'威斯布鲁克',
            'status':'缺阵',
            'detail':'轮休一场，无法出战周一对阵爵士的季前赛',
            'important':true
        },{
            'name':'马库斯.莫里斯',
            'status':'缺阵',
            'detail':'腹股沟受伤，无法出战周一对阵爵士的季前赛',
            'important':false
        }
    ],
    //洛杉矶湖人
    ...
    heat:[
        {
            'name':'凯尔布.马丁',
            'status':'出战存疑',
            'detail':'左膝受伤，周三对阵黄蜂的比赛出战存疑，每日观察',
            'important':false
        }
    ],
    //密尔沃基雄鹿
    bucks:[
        {
            'name':'米德尔顿',
            'status':'缺阵',
            'detail':'右膝轻微挫伤，无法出战周一对阵公牛的季前赛',
            'important':true
        },{
            'name':'利拉德',
            'status':'缺阵',
            'detail':'轮休一场，无法出战周一对阵公牛的季前赛',
            'important':true
        },{
            'name':'字母哥',
            'status':'缺阵',
    ...
    knicks:[
        {
            ...
            'name':'杰里科.西姆斯',
            'status':'出战存疑',
            'detail':'右肩受伤，大概率可以出战周二对阵凯尔特人的季前赛',
            'important':false
        },{
            'name':'奎格利',
            'status':'大概率出战',
            'detail':'脚踝轻微扭伤，大概率可以出战周二对阵凯尔特人的季前赛',
            'important':false
        }
    ],
    //俄克拉荷马城雷霆
    ...
    suns:[
        {
            ...
            'name':'古德温',
            'status':'缺阵',
            'detail':'腿筋拉伤，无法出战周一对阵活塞的季前赛',
            'important':false
        },{
            'name':'维恩莱特',
            'status':'缺阵',
            'detail':'小腿受伤，无法出战周一对阵活塞的季前赛',
            'important':false
        }
    ],
    //波特兰开拓者
    ...
    spurs:[
        {
            ...
            'name':'索汉',
            'status':'出战存疑',
            'detail':'腿部受伤，周二对阵雷霆的季前赛出战存疑',
            'important':true
        },{
            'name':'KJ.约翰逊',
            'status':'出战存疑',
            'detail':'全身酸痛，周二对阵雷霆的季前赛出战存疑',
            'important':true
        }
    ],
    //多伦多猛龙
