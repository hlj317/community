    ...
    cavaliers:[
        {
            'name':'温德勒',
            'status':'出战',
            'detail':'可以出战周日六对阵公牛的比赛',
            'important':false
        },{
            'name':'卢比奥',
            'status':'出战',
            'detail':'伤病管理，可以出战周日六对阵公牛的比赛',
            'important':false
        }
    ],
    //达拉斯独行侠
