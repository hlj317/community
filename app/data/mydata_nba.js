    ...
    kings:[
        {
            ...
            'name':'科恩.艾丽斯',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周四对阵鹈鹕的比赛',
            'important':false
        },{
            'name':'萨沙.维琴科夫',
            'status':'出战存疑',
            'detail':'身体不适，周四对阵鹈鹕的比赛出战存疑',
            'important':false
        },{
            'name':'基根.默雷',
            'status':'出战存疑',
