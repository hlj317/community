    ...
    hornets:[
        {
            ...
            'name':'布兰登.米勒',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周三对阵热火的比赛',
            'important':false
        },{
            'name':'海沃德',
            'status':'缺阵',
            'detail':'腿筋拉伤，无法出战周三对阵热火的比赛',
            'important':true
        }
    ],
    //芝加哥公牛
    ...
    magic:[
        {
            ...
            'name':'加里.哈里斯',
            'status':'缺阵',
            'detail':'腹股沟受伤，无法出战周三对阵篮网的比赛',
            'important':false
        },{
            'name':'富尔茨',
            'status':'缺阵',
            'detail':'膝盖肿胀，无法出战周三对阵篮网的比赛',
            'important':true
        }
    ],
    //费城76人
    seven6ers:[
        {
            'name':'巴图姆',
            'status':'缺阵',
            'detail':'个人原因，无法出战周三对阵步行者的比赛',
            'important':false
        },{
            'name':'恩比德',
            'status':'出战存疑',
            'detail':'左臀受伤，周三对阵步行者的比赛出战存疑',
            'important':true
        },{
            'name':'乌布雷',
            'status':'长期缺阵',
    ...
    kings:[
        {
            ...
            'name':'莱尔斯',
            'status':'出战存疑',
            'detail':'左小腿受伤，周四对阵湖人的比赛出战存疑',
            'important':false
        },{
            'name':'莱恩',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周四对阵湖人的比赛出战存疑',
            'important':false
        }
    ],
    //圣安东尼奥马刺
    ...
    raptors:[
        {
            ...
            'name':'小特伦特',
            'status':'小概率出战',
            'detail':'腿部受伤，小概率可以出战周四对阵雄鹿的比赛',
            'important':false
        },{
            'name':'阿奴诺比',
            'status':'小概率出战',
            'detail':'手指受伤，小概率可以出战周四对阵雄鹿的比赛',
            'important':true
        }
    ],
    //犹它爵士
