    ...
    rockets:[
        {
            ...
            'name':'狄龙.布鲁克斯',
            'status':'缺阵',
            'detail':'斜方肌拉伤，无法出战周六对阵76人的比赛',
            'important':true
        },{
            'name':'贾巴里.史密斯',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周六对阵76人的比赛',
            'important':true
        }
    ],
    //印第安纳步行者
    pacers:[
        {
            'name':'布鲁斯.布朗',
            'status':'缺阵',
            'detail':'右膝受伤，无法出战周日对阵尼克斯的比赛',
            'important':true
        },{
            'name':'以赛亚.杰克逊',
            'status':'出战存疑',
            'detail':'右手指受伤，周日对阵尼克斯的比赛出战存疑',
            'important':false
        }
    ],
    //洛杉矶快船
    ...
    lakers:[
        {
            ...
            'name':'詹姆斯',
            'status':'出战存疑',
            'detail':'左膝受伤，周日对阵森林狼的比赛出战存疑',
            'important':true
        },{
            'name':'安东尼.戴维斯',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周日对阵森林狼的比赛出战存疑',
            'important':true
        },{
            'name':'雷迪什',
            'status':'出战',
    ...
    magic:[
        {
            ...
            'name':'英格尔斯',
            'status':'缺阵',
            'detail':'左脚踝扭伤，无法出战周六对阵尼克斯的比赛',
            'important':false
        },{
            'name':'艾萨克',
            'status':'缺阵',
            'detail':'右腿筋拉伤，无法出战周六对阵尼克斯的比赛',
            'important':false
        },{
            'name':'加里.哈里斯',
            'status':'缺阵',
    ...
    suns:[
        {
            ...
            'name':'奥科吉',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周日对阵黄蜂的比赛',
            'important':false
        },{
            'name':'利特尔',
            'status':'缺阵',
            'detail':'膝盖受伤，无法出战周日对阵黄蜂的比赛',
            'important':false
        }
    ],
    //波特兰开拓者
    blazers:[
        {
            ...
            'name':'夏普',
            'status':'缺阵',
            'detail':'腹股沟拉伤，无法出战周六对阵马刺的比赛',
            'important':true
        },{
            'name':'艾顿',
            'status':'缺阵',
            'detail':'右膝受伤，无法出战周六对阵马刺的比赛',
            'important':true
        },{
            'name':'安芬尼.西蒙斯',
            'status':'缺阵',
