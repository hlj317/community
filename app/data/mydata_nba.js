    ...
    timberwolves:[
        {
            'name':'奥科吉',
            'status':'出战存疑',
            'detail':'腿部受伤，周一对阵爵士的比赛出战存疑',
            'important':false
        },{
            'name':'贝弗利',
            'status':'出战存疑',
            'detail':'脚踝受伤，周一对阵爵士的比赛出战存疑',
            'important':true
        },{
            'name':'拉塞尔',
            'status':'出战存疑',
            'detail':'左胫骨挫伤，周一对阵爵士的比赛出战存疑',
            'important':true
        },{
            'name':'莱特',
            'status':'出战存疑',
    ...
    suns:[
        {
            ...
            'name':'杰.克劳德',
            'status':'出战存疑',
            'detail':'手腕受伤，周一对阵马刺的比赛出战存疑',
            'important':true
        },{
            'name':'艾顿',
            'status':'出战存疑',
            'detail':'右脚踝受伤，周一对阵马刺的比赛出战存疑',
            'important':true
        },{
            'name':'纳达尔',
            'status':'缺阵',
