    ...
    celtics:[
        {
            'name':'豪瑟',
            'status':'缺阵',
            'detail':'右肩受伤，无法出战周二对阵步行者的比赛',
            'important':false
        },{
            'name':'塔图姆',
            'status':'缺阵',
            'detail':'左脚踝扭伤，无法出战周二对阵步行者的比赛',
            'important':true
        },{
            'name':'波尔津吉斯',
            'status':'出战',
    ...
    mavericks:[
        {
            ...
            'name':'艾克萨姆',
            'status':'缺阵',
            'detail':'右脚后跟受伤，无法出战周三对阵灰熊的比赛',
            'important':false
        },{
            'name':'莱福利',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周三对阵灰熊的比赛',
            'important':true
        },{
            'name':'东契奇',
            'status':'出战存疑',
            'detail':'四头肌受伤，周三对阵灰熊的比赛出战存疑',
            'important':true
        }
    ],
    //丹佛掘金
    ...
    lakers:[
        {
            ...
            'name':'詹姆斯',
            'status':'大概率出战',
            'detail':'小腿酸痛，大概率可以出战周三对阵猛龙的比赛',
            'important':true
        },{
            'name':'八村塁',
            'status':'缺阵',
            'detail':'左小腿受伤，无法出战周三对阵猛龙的比赛',
            'important':false
        }
    ],
    //孟菲斯灰熊
    grizzlies:[
        {
            ...
            'name':'阿尔达玛',
            'status':'缺阵',
            'detail':'左膝受伤，无法出战周三对阵独行侠的比赛',
            'important':false
        },{
            'name':'小贾伦.杰克逊',
            'status':'出战存疑',
            'detail':'右膝受伤，周三对阵独行侠的比赛出战存疑',
            'important':true
        },{
            'name':'贾.莫兰特',
            'status':'长期缺阵',
    ...
    magic:[
        {
            ...
            'name':'加里.哈里斯',
            'status':'缺阵',
            'detail':'小腿受伤，无法出战周三对阵森林狼的比赛',
            'important':false
        },{
            'name':'温德勒.卡特',
            'status':'缺阵',
            'detail':'右膝受伤，无法出战周三对阵森林狼的比赛',
            'important':false
        }
    ],
    //费城76人
