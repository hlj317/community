    ...
    mavericks:[
        {
            ...
            'name':'小哈达威',
            'status':'出战存疑',
            'detail':'背部受伤，周日对阵雷霆的比赛出战存疑',
            'important':false
        },{
            'name':'东契奇',
            'status':'出战存疑',
            'detail':'个人原因，周日对阵雷霆的比赛出战存疑',
            'important':true
        },{
            'name':'艾克萨姆',
            'status':'出战存疑',
    ...
    warriors:[
        {
            ...
            'name':'克里斯.保罗',
            'status':'缺阵',
            'detail':'腿部受伤，预计会缺阵几场比赛',
            'important':true
        },{
            'name':'维金斯',
            'status':'出战存疑',
            'detail':'手指受伤，周日对阵快船的比赛出战存疑',
            'important':true
        }
    ],
    //休斯顿火箭
    ...
    pelicans:[
        {
            'name':'马特.里安',
            'status':'出战存疑',
            'detail':'右小腿受伤，周日对阵公牛的比赛出战存疑',
            'important':false
        },{
            'name':'阿尔瓦拉多',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周日对阵公牛的比赛出战存疑',
            'important':true
        },{
            'name':'小拉里.南斯',
            'status':'长期缺阵',
    ...
    kings:[
        {
            ...
            'name':'基根.默雷',
            'status':'出战存疑',
            'detail':'背部受伤，周日对阵掘金的比赛出战存疑',
            'important':true
        },{
            'name':'莱尔斯',
            'status':'出战存疑',
            'detail':'右脚踝扭伤，周日对阵掘金的比赛出战存疑',
            'important':false
        }
    ],
    //圣安东尼奥马刺
    ...
    jazz:[
        {
            'name':'马尔坎宁',
            'status':'缺阵',
            'detail':'左腿筋拉伤，无法出战周日对阵开拓者的比赛',
            'important':true
        },{
            'name':'邓恩',
            'status':'缺阵',
            'detail':'个人原因，无法出战周日对阵开拓者的比赛',
            'important':false
        },{
            'name':'克拉克森',
            'status':'缺阵',
            'detail':'腿筋拉伤，无法出战周日对阵开拓者的比赛',
            'important':true
        },{
            'name':'奥利尼克',
            'status':'出战存疑',
            'detail':'右肩受伤，周日对阵开拓者的比赛出战存疑',
            'important':false
        }            
    ],
    //华盛顿奇才
