const nbaData = {
    ...
    celtics:[
        {        
            ...
            'name':'斯马特',
            'status':'出战存疑',
            'detail':'颈部受伤，周六对阵猛龙的比赛出战存疑',
            'important':true
        },{        
            'name':'普理查德',
            'status':'出战存疑',
            'detail':'脚后跟受伤，周六对阵猛龙的比赛出战存疑',
            'important':false
        },{        
            'name':'德里克.怀特',
            'status':'出战存疑',
            'detail':'左脚踝受伤，周六对阵猛龙的比赛出战存疑',
            'important':false
        }
    ],
    //布鲁克林篮网
    ...
    seven6ers:[
        {        
            'name':'梅尔顿',
            'status':'出战存疑',
            'detail':'右小腿受伤，周六对阵老鹰的比赛出战存疑',
            'important':false
        },{        
            'name':'马克西',
            'status':'出战存疑',
            'detail':'颈部受伤，周六对阵老鹰的比赛出战存疑',
            'important':true
        },{        
            'name':'恩比德',
            'status':'缺阵',
