    ...
    cavaliers:[
        {
            ...
            'name':'加兰',
            'status':'缺阵',
            'detail':'左腿筋拉伤，无法出战周三对阵尼克斯的比赛',
            'important':true
        },{
            'name':'米切尔',
            'status':'出战存疑',
            'detail':'腿筋拉伤，周三对阵尼克斯的比赛出战存疑',
            'important':true
        },{
            'name':'杰罗姆',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周三对阵尼克斯的比赛',
            'important':false
        }
    ],
    //达拉斯独行侠
