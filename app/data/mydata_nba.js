    ...
    hornets:[
        {
            ...
            'name':'乌布雷',
            'status':'出战存疑',
            'detail':'伤病管理，周六对阵公牛的比赛出战存疑',
            'important':false
        },{
            'name':'海沃德',
            'status':'出战存疑',
            'detail':'肋骨受伤，周六对阵公牛的比赛出战存疑',
            'important':true
        }
    ],
    //芝加哥公牛
    ...
    spurs:[
        {
            ...
            'name':'凯尔登.约翰逊',
            'status':'出战存疑',
            'detail':'腿部受伤，周六对阵勇士的比赛出战存疑',
            'important':true
        },{
            'name':'瓦塞尔',
            'status':'出战存疑',
            'detail':'左膝受伤，周六对阵勇士的比赛出战存疑',
            'important':true
        },{
            'name':'朗福德',
            'status':'出战存疑',
    ...
    raptors:[
        {
            ...
            'name':'班顿',
            'status':'出战存疑',
            'detail':'拇指受伤，周六对阵76人的比赛出战存疑',
            'important':false
        },{
            'name':'小特伦特',
            'status':'出战存疑',
            'detail':'肘部受伤，周六对阵76人的比赛出战存疑',
            'important':false
        },{
            'name':'威尔.巴顿',
            'status':'出战存疑',
            'detail':'脚踝受伤，周六对阵76人的比赛出战存疑',
            'important':false
        }
    ],
    //犹它爵士
