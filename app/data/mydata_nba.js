    ...
    nets:[
        {
            ...
            'name':'小丹尼斯.史密斯',
            'status':'缺阵',
            'detail':'背部受伤，无法出战周一对阵公牛的比赛',
            'important':false
        },{
            'name':'克拉克斯顿',
            'status':'缺阵',
            'detail':'脚踝扭伤，无法出战周一对阵公牛的比赛',
            'important':true
        },{
            'name':'卡梅伦.约翰逊',
            'status':'出战存疑',
    ...
    lakers:[
        {
            ...
            'name':'勒布朗.詹姆斯',
            'status':'出战存疑',
            'detail':'左小腿受伤，周二对阵76人的比赛出战存疑',
            'important':true
        },{
            'name':'雷迪什',
            'status':'出战存疑',
            'detail':'腹股沟拉伤，周二对阵76人的比赛出战存疑',
            'important':false
        }
    ],
    //孟菲斯灰熊
