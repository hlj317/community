    ...
    hornets:[
        {
            ...
            'name':'海沃德',
            'status':'出战存疑',
            'detail':'身体不适，周二对阵猛龙的比赛出战存疑',
            'important':true
        },{
            'name':'罗齐尔',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周二对阵猛龙的比赛出战存疑',
            'important':true
        },{
            'name':'拉梅洛.鲍尔',
            'status':'缺阵',
    ...
    bulls:[
        {
            ...
            'name':'卡鲁索',
            'status':'出战存疑',
            'detail':'脚踝扭伤，周二对阵76人的比赛出战存疑',
            'important':true
        },{
            'name':'克雷格',
            'status':'缺阵',
            'detail':'右脚后跟受伤，无法出战周二对阵76人的比赛',
            'important':false
        }
    ],
    //克利夫兰骑士
    ...
    lakers:[
        {
            ...
            'name':'安东尼.戴维斯',
            'status':'出战存疑',
            'detail':'臀部受伤，周二对阵马刺的比赛出战存疑',
            'important':true
        },{
            'name':'詹姆斯',
            'status':'出战存疑',
            'detail':'腿部酸痛，周二对阵马刺的比赛出战存疑',
            'important':true
        },{
            'name':'伍德',
            'status':'出战存疑',
    ...
    magic:[
        {
            ...
            'name':'富尔茨',
            'status':'缺阵',
            'detail':'膝盖肿胀，无法出战周一对阵凯尔特人的比赛',
            'important':true
        },{
            'name':'英格尔斯',
            'status':'缺阵',
            'detail':'左脚踝扭伤，无法出战周一对阵凯尔特人的比赛',
            'important':false
        },{
            'name':'萨格斯',
            'status':'出战',
