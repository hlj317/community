    ...
    hawks:[
        {
            ...
            'name':'亨特',
            'status':'出战存疑',
            'detail':'腿部受伤，周六对阵猛龙的比赛出战存疑',
            'important':true
        },{
            'name':'AJ.格里芬',
            'status':'缺阵',
            'detail':'个人原因，无法出战周六对阵猛龙的比赛',
            'important':false
        }
    ],
    //波士顿凯尔特人
    ...
    heat:[
        {
            'name':'希罗',
            'status':'缺阵',
            'detail':'脚踝2级扭伤，无法出战周五对阵公牛的比赛',
            'important':true
        },{
            'name':'海史密斯',
            'status':'缺阵',
            'detail':'背部受伤，无法出战周五对阵公牛的比赛',
            'important':false
        },{
            'name':'阿德巴约',
            'status':'缺阵',
            'detail':'臀部受伤，无法出战周五对阵公牛的比赛',
            'important':true
        },{
            'name':'约什.理查德森',
            'status':'缺阵',
            'detail':'头部受伤，无法出战周五对阵公牛的比赛',
            'important':false
        },{
            'name':'德鲁.史密斯',
            'status':'长期缺阵',
    ...
    jazz:[
        {
            ...
            'name':'科林斯',
            'status':'缺阵',
            'detail':'身体不适，无法出战周五对阵开拓者的比赛',
            'important':true
        },{
            'name':'马尔坎宁',
            'status':'缺阵',
            'detail':'腿筋拉伤，无法出战周五对阵开拓者的比赛',
            'important':true
        },{
            'name':'克拉克森',
            'status':'缺阵',
